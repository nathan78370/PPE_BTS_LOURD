...
namespace ppelourd
{
    public partial class InsertProduit : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string sql = $"insert into produit (titre_produit, description_courte, description_longue, qteProduit, prix, id_categorie, id_image) Values ('{Libelle}', '{MotsCles}', '{Description}', {Quantite}, {strprix}, {idcategorie}, {idimage}) ";
        ...
        private void labelVerif_Click(object sender, EventArgs e)
        {

        }

        private void txtMots_TextChanged(object sender, EventArgs e)
        {
